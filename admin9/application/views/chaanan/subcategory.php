            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                     	<form method="post"	action="<?php echo base_url()?>apanelForms/createSubCategory" enctype="multipart/Form-data" >
							<div class="card-body">
										...
										<div class="row">
										   ...
										   <?php  }}?>
												...
												<div class="form-group row">
													<div class="col-md-5"><label>Sub Category Naem</label></div>
													<div class="col-md-7">
