...
class Home extends CI_Controller{
	...
	<div class="col-sm-10 ">
		...
		<th style='width:250px; text-align:center;'>Sub Category</th>
		<th style='width:250px;	text-align:center;'>Category</th>
		...
		<tr id='row<?php echo $i;?>'>
				<td ><?php echo '&nbsp;&nbsp;&nbsp;  '.$i.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';?></td>
											...
											<?php $val = $this->db->get("sub_category")->result();
											foreach($val as $v):?>
											<option value="<?php echo $v->cat_id;?>"><?php echo $v->name;?></option>
											<?php endforeach;?>
											...
											$("#hsn_sac<?php echo $i; ?>").change(function(){
												var subid = $("#hsn_sac<?php echo $i; ?>").val();
											
												//alert(edate+","+section+","+classv+","+sdate)
												$.post("<?php echo site_url("apanel/getSubject") ?>",{subid : subid}, function(data)
													{//alert(data);
						                    ...
						                    <input type='text' class='form-control' id='pRate<?php echo $i; ?>' name='pRate<?php echo $i; ?>'  width='100%'></td>
						                      ...
						                      <script>//console.log("HII");
        										$("#itemCompanyName<?php echo $i; ?>").change(function(){
        												...
        												$.post("<?php echo site_url("apanel/getTotQ") ?>",{subid : subid,  itamName : itamName }, function(data){
