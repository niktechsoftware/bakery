  ...
  <body class="page-init">
    <div class="ps-searchbox">
      ...
      <div class="container">
        <header>
          ...
          <form method="post" action="http://nouthemes.net/product-grid.html">
    ...
    <header class="header" data-responsive="1199">
      ...
      <nav class="navigation">
        <div class="container">
          ...
          </div><a class="ps-logo" href="index.html"><img src="<?php echo base_url();?>assets/images/logo-1.png" alt=""></a>
                  ...
                  <div class="ps-cart__listing">
                    <div class="ps-cart__content">
                      <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                        <div class="ps-cart-item__thumbnail"><a href="product-detail.html"></a><img src="<?php echo base_url();?>assets/images/cake/img-cake-1.jpg" alt=""></div>
                        <div class="ps-cart-item__content"><a class="ps-cart-item__title" href="product-detail.html">Amazin’ Glazin’</a>
                          <p><span>Quantity:<i>12</i></span><span>Total:<i>£176</i></span></p>
                        </div>
                      </div>
                      <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                        <div class="ps-cart-item__thumbnail"><a href="product-detail.html"></a><img src="<?php echo base_url();?>assets/images/cake/img-cake-2.jpg" alt=""></div>
                        <div class="ps-cart-item__content"><a class="ps-cart-item__title" href="product-detail.html">The Crusty Croissant</a>
                          <p><span>Quantity:<i>12</i></span><span>Total:<i>£176</i></span></p>
                        </div>
                      </div>
                      <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                        <div class="ps-cart-item__thumbnail"><a href="product-detail.html"></a><img src="<?php echo base_url();?>assets/images/cake/img-cake-3.jpg" alt=""></div>
    ...
    <div class="page-wrap">
      <div class="ps-banner--home-1">
        <div class="rev_slider_wrapper fullscreen-container" id="revolution-slider-1" data-alias="concept121" data-source="gallery" style="background-color:#000000;padding:0px;">
          <div class="rev_slider fullscreenbanner" id="rev_slider_1059_1" style="display:none;" data-version="5.4.1">
            <ul class="ps-banner">
              <li data-index="rs-2972" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="<?php echo base_url();?>assets/images/concept4-100x100.jpg" data-rotate="0" data-saveperformance="off" data-title="Web Show" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description=""><img class="rev-slidebg" src="<?php echo base_url();?>assets/images/banner/img-slider-1.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" data-no-retina>
              ...
              <li data-index="rs-2973" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="<?php echo base_url();?>assets/images/concept4-100x100.jpg" data-rotate="0" data-saveperformance="off" data-title="Web Show" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description=""><img class="rev-slidebg" src="<?php echo base_url();?>assets/images/banner/img-slider-2.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" data-no-retina>
      ...
      <div class="ps-section pt-80 pb-40">
        <div class="container">
          <div class="ps-countdown">
            <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 "><img src="<?php echo base_url();?>assets/images/counter.png" alt="">
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
            ...
            <div class="owl-slider owl-slider--best-seller" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="30" data-owl-nav="true" data-owl-dots="false" data-owl-animate-in="" data-owl-animate-out="" data-owl-item="4" data-owl-item-xs="1" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-nav-left="&lt;i class=&quot;ps-icon--back&quot;&gt;&lt;/i&gt;" data-owl-nav-right="&lt;i class=&quot;ps-icon--next&quot;&gt;&lt;/i&gt;">
              <div class="ps-product">
                <div class="ps-product__thumbnail">
                  <div class="ps-badge"><span>-50%</span></div><a class="ps-product__overlay" href="product-detail.html"></a><img src="<?php echo base_url();?>assets/images/cake/img-cake-7.jpg" alt="">
              ...
              <div class="ps-product">
                <div class="ps-product__thumbnail">
                  <div class="ps-badge ps-badge--new"><span>New</span></div><a class="ps-product__overlay" href="product-detail.html"></a><img src="<?php echo base_url();?>assets/images/cake/img-cake-8.jpg" alt="">
                  <ul class="ps-product__action">
                    <li><a class="popup-modal" href="#quickview-modal" data-effect="mfp-zoom-out" data-tooltip="View"><i class="ps-icon--search"></i></a></li>
                    <li><a href="#" data-tooltip="Add to wishlist"><i class="ps-icon--heart"></i></a></li>
                    <li><a href="#" data-tooltip="Compare"><i class="ps-icon--reload"></i></a></li>
          ...
          <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-animate-in="" data-owl-animate-out="" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-nav-left="&lt;i class=&quot;fa fa-angle-left&quot;&gt;&lt;/i&gt;" data-owl-nav-right="&lt;i class=&quot;fa fa-angle-right&quot;&gt;&lt;/i&gt;">
            <div class="ps-testimonial text-center pt-80 pb-100">
              <div class="ps-testimonial__header">
                <div class="ps-testimonial__thumbnail"><img src="<?php echo base_url();?>assets/images/testimonial/1.jpg" alt=""></div>
                <select class="ps-rating">
                  <option value="1">1</option>
                  <option value="1">2</option>
                  <option value="1">3</option>
            ...
            <div class="ps-testimonial text-center pt-80 pb-100">
              <div class="ps-testimonial__header">
                <div class="ps-testimonial__thumbnail"><img src="<?php echo base_url();?>assets/images/testimonial/2.jpg" alt=""></div>
                <select class="ps-rating">
                  <option value="1">1</option>
                  <option value="1">2</option>
                  <option value="1">3</option>
            ...
            <div class="ps-testimonial text-center pt-80 pb-100">
              <div class="ps-testimonial__header">
                <div class="ps-testimonial__thumbnail"><img src="<?php echo base_url();?>assets/images/testimonial/3.jpg" alt=""></div>
                <select class="ps-rating">
                  <option value="1">1</option>
                  <option value="1">2</option>
                  <option value="1">3</option>
            ...
            <div class="ps-testimonial text-center pt-80 pb-100">
              <div class="ps-testimonial__header">
                <div class="ps-testimonial__thumbnail"><img src="<?php echo base_url();?>assets/images/testimonial/4.jpg" alt=""></div>
                <select class="ps-rating">
                  <option value="1">1</option>
                  <option value="1">2</option>
                  <option value="1">3</option>
              ...
              <div class="ps-masonry">
                ...
                <div class="grid-item high wide">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-offer"><img src="<?php echo base_url();?>assets/images/offer/banner-1.jpg" alt=""><a class="ps-offer__overlay" href="#"></a></div>
                  </div>
                </div>
                <div class="grid-item">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-offer"><img src="<?php echo base_url();?>assets/images/offer/banner-2.jpg" alt=""><a class="ps-offer__overlay" href="#"></a></div>
                  </div>
                </div>
                <div class="grid-item high">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-offer"><img src="<?php echo base_url();?>assets/images/offer/banner-3.jpg" alt=""><a class="ps-offer__overlay" href="#"></a></div>
                  </div>
                </div>
                <div class="grid-item wide">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-offer"><img src="<?php echo base_url();?>assets/images/offer/banner-4.jpg" alt=""><a class="ps-offer__overlay" href="#"></a></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                  ...
                  <div class="ps-section__content">
                    <div class="ps-product--list">
                      <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="product-detail.html"></a><img src="<?php echo base_url();?>assets/images/cake/img-cake-6.jpg" alt=""></div>
                      <div class="ps-product__content">
                    ...
                    <div class="ps-product--list">
                      <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="product-detail.html"></a><img src="<?php echo base_url();?>assets/images/cake/img-cake-8.jpg" alt=""></div>
                      <div class="ps-product__content">
                    ...
                    <div class="ps-product--list">
                      <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="product-detail.html"></a><img src="<?php echo base_url();?>assets/images/cake/img-cake-11.jpg" alt=""></div>
                      <div class="ps-product__content">
                    ...
                    <div class="row">
                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                            <article class="ps-people">
                              <div class="ps-people__thumbnail"><a class="ps-people__overlay" href="#"></a><img src="<?php echo base_url();?>assets/images/team/team-1.jpg" alt=""></div>
                          ...
                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                            <article class="ps-people">
                              <div class="ps-people__thumbnail"><a class="ps-people__overlay" href="#"></a><img src="<?php echo base_url();?>assets/images/team/team-2.jpg" alt=""></div>
                              <div class="ps-people__content">
                                <h4>Christian Gregory</h4><span class="ps-people__position">CEO - Founder</span>
                                <p>Jelly topping halvah caramels sweet cake gummi bears toffee.</p>
                                    <ul class="ps-people__social">
      ...
      <section class="ps-section ps-section--news pt-100 pb-100">
        <div class="container">
          ...
          <div class="ps-section__content">
            <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                    <div class="ps-new ps-new--large"><img src="<?php echo base_url();?>assets/images/new/new-large.jpg" alt="">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                    <div class="ps-new"><img src="<?php echo base_url();?>assets/images/new/new-small-1.jpg" alt="">
                      <div class="ps-new__container">
                        <header class="ps-new__header">
                    ...
                    <div class="ps-new"><img src="<?php echo base_url();?>assets/images/new/new-small-2.jpg" alt="">
                      <div class="ps-new__container">
                        <header class="ps-new__header">
                          <p>by<a href="#"> Athony</a> / February 12, 2017</p><a class="ps-new__title" href="blog-detail.html">Where I Learning Cook Cupcakes ?</a>
                        </header>
      ...
      <div class="ps-section ps-section--partner">
        <div class="container">
          <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="40" data-owl-nav="false" data-owl-dots="false" data-owl-animate-in="" data-owl-animate-out="" data-owl-item="6" data-owl-item-xs="3" data-owl-item-sm="4" data-owl-item-md="5" data-owl-item-lg="6" data-owl-nav-left="&lt;i class=&quot;fa fa-angle-left&quot;&gt;&lt;/i&gt;" data-owl-nav-right="&lt;i class=&quot;fa fa-angle-right&quot;&gt;&lt;/i&gt;"><a href="#"><img src="<?php echo base_url();?>assets/images/partner/1.png" alt=""></a><a href="#"><img src="<?php echo base_url();?>assets/images/partner/2.png" alt=""></a><a href="#"><img src="<?php echo base_url();?>assets/images/partner/3.png" alt=""></a><a href="#"><img src="<?php echo base_url();?>assets/images/partner/4.png" alt=""></a><a href="#"><img src="<?php echo base_url();?>assets/images/partner/5.png" alt=""></a><a href="#"><img src="<?php echo base_url();?>assets/images/partner/6.png" alt=""></a><a href="#"><img src="<?php echo base_url();?>assets/images/partner/7.png" alt=""></a><a href="#"><img src="<?php echo base_url();?>assets/images/partner/8.png" alt=""></a>
          </div>
        </div>
      </div>
      <section class="ps-section ps-section--map">
        ...
        <div class="ps-delivery">
          ...
          <div class="ps-delivery__content">
            <form class="ps-delivery__form" action="http://nouthemes.net/html/bakery/product-listing.html" method="post">
        ...
        <div class="container">
          <div class="ps-subscribe">
            <div class="row">
                  ...
                  <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 "><a class="ps-subscribe__logo" href="index.html"><img src="<?php echo base_url();?>assets/images/logo-1.png" alt=""></a>
                  </div>
                  <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 ">
                    <h4>SUBSCRIBE EMAIL</h4>
                    <p>Give us your email, and we shall send regular updates for new stuff and events.</p>
                    <form class="ps-subscribe__form" method="post" action="http://nouthemes.net/html/bakery/_action">
      ...
      <div class="mfp-with-anim modal-popup mfp-hide" id="modal--subscribe">
        <button class="modal-close"><i class="fa fa-remove"></i></button><img src="<?php echo base_url();?>assets/images/img-demo-4.png" alt="">
        <form action="http://nouthemes.net/html/bakery/_action" method="post">
    ...
    <script type="text/javascript" src="<?php echo base_url();?>assets/<?php echo base_url();?>assets/plugins/bootstrap/dist/js/bootstrap.min.js"></script>
...
<!-- Mirrored from nouthemes.net/html/bakery/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Oct 2020 07:30:59 GMT -->
</html>